/*
Date: Feb 13
Description: This program is a simulator for a vending machine that tracks the
transactions and stock of 3 snacks in it. Additionally it also track the 
times for the transactions.
*/
#include <iostream>
#include <iomanip>
#include <ctime>
